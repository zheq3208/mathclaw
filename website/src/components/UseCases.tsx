...
const CATEGORIES: Array<{
  ...
  { key: "literature", icon: BookOpen, items: 3 },
  { key: "writing", icon: PenLine, items: 2 },
  { key: "experiment", icon: FlaskConical, items: 2 },
  { key: "tracking", icon: Radar, items: 2 },
  { key: "collaboration", icon: Users, items: 1 },
