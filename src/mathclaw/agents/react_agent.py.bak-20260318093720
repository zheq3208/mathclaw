"""ScholarAgent 鈥?the core ReAct agent for MathClaw.
...
class ScholarAgent:
    ...
    working_dir:
        Path to the MathClaw working directory.
    """
    ...
    def _load_skill(self, skill_dir: Path) -> None:
        ...
        try:
            ...
            # resolve correctly against the installed mathclaw package.
            module_fqn = f"mathclaw.agents.skills.{skill_dir.name}"
    ...
    def _reasoning(
        ...
        **kwargs: Any,
        ...
        if self.model is None:
            return (
                "No LLM model configured. Please run `mathclaw init` "
