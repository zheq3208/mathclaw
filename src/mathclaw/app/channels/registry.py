...
_BUILTIN_SPECS: tuple[tuple[str, str, str], ...] = (
    ("console", "mathclaw.app.channels.console_channel", "ConsoleChannel"),
    ("telegram", "mathclaw.app.channels.telegram", "TelegramChannel"),
    ("discord", "mathclaw.app.channels.discord_", "DiscordChannel"),
    ("dingtalk", "mathclaw.app.channels.dingtalk", "DingTalkChannel"),
    ("feishu", "mathclaw.app.channels.feishu", "FeishuChannel"),
    ("imessage", "mathclaw.app.channels.imessage", "IMessageChannel"),
    ("qq", "mathclaw.app.channels.qq", "QQChannel"),
    ("wecom", "mathclaw.app.channels.wecom", "WecomChannel"),
    ("voice", "mathclaw.app.channels.voice", "VoiceChannel"),
)
