...
- 初始化与配置：`mathclaw init`, `mathclaw channels config`
- 运维与诊断：`mathclaw daemon`, `mathclaw cron`, `mathclaw channels list`
- 本地开发与调试：`mathclaw app` + console dev server
